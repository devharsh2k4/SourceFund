...
exports.prepareDeterministicDeployTransactionFromBytecode = prepareDeterministicDeployTransactionFromBytecode;
 ...
 * @internal
 */
function prepareDeterministicDeployTransactionFromBytecode(options) {
    const { client, chain } = options;
    return (0, prepare_transaction_js_1.prepareTransaction)({
        client,
        chain,
        ...
        data: async () => {
            const infraContractInfo = await (0, compute_published_contract_deploy_info_js_1.computeDeploymentInfoFromBytecode)(options);
            return infraContractInfo.initBytecodeWithsalt;
        },
    });
}
