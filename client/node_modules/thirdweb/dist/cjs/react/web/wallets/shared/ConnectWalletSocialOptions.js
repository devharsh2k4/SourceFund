...
const ConnectWalletSocialOptions = (props) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "md", style: {
            position: "relative",
        }, children: [optionalImageMetadata && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Img_js_1.Img, { client: props.client, src: optionalImageMetadata.src, alt: optionalImageMetadata.alt, width: `${optionalImageMetadata.width}`, height: `${optionalImageMetadata.height}`, style: { margin: "auto" } }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xxs" })] })), hasSocialLogins && ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", center: "x", gap: socialLogins.length > 4 ? "xs" : "sm", style: {
                ...
                (isEmailEnabled || isPhoneEnabled) && (0, jsx_runtime_1.jsx)(TextDivider_js_1.TextDivider, { text: locale.or }), isEmailEnabled && ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: inputMode === "email" ? ((0, jsx_runtime_1.jsx)(InputSelectionUI_js_1.InputSelectionUI, { type: type, onSelect: (value) => {
                    ...
                    }, title: locale.emailPlaceholder, disabled: props.disabled })) })), isPhoneEnabled && ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: inputMode === "phone" ? ((0, jsx_runtime_1.jsx)(InputSelectionUI_js_1.InputSelectionUI, { format: "phone", type: type, onSelect: (value) => {
                    ...
                    }, title: locale.phonePlaceholder, disabled: props.disabled })) })), passKeyEnabled && ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { client: props.client, icon: walletIcon_js_1.passkeyIcon, onClick: () => {
                        handlePassKeyLogin();
                    }, title: locale.passkey, disabled: props.disabled }) })), props.isLinking && ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { client: props.client, icon: (0, walletIcon_js_1.getWalletIcon)(""), onClick: () => {
                        handleWalletLogin();
