...
import { computeDeploymentInfoFromBytecode, computeDeploymentInfoFromContractId, } from "../../utils/any-evm/compute-published-contract-deploy-info.js";
 ...
 * @internal
 */
export function prepareDeterministicDeployTransactionFromBytecode(options) {
    const { client, chain } = options;
    return prepareTransaction({
        client,
        chain,
        ...
        data: async () => {
            const infraContractInfo = await computeDeploymentInfoFromBytecode(options);
            return infraContractInfo.initBytecodeWithsalt;
        },
    });
}
