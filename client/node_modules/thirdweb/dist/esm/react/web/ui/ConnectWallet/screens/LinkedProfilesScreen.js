    ...
    return (_jsxs(Container, { style: {
            minHeight: "300px",
                    ...
                    height: "300px",
                                ...
                                }, children: [_jsx(AddUserIcon, { size: iconSize.md }), _jsx(Text, { color: "primaryText", children: props.locale.manageWallet.linkProfile })] }), _jsx(Spacer, { y: "xs" }), connectedProfiles?.map((profile) => (_jsx(LinkedProfile, { profile: profile, client: props.client }, `${profile.type}-${getProfileDisplayName(profile)}`)))] }), _jsx(Spacer, { y: "md" })] }))] }));
}
