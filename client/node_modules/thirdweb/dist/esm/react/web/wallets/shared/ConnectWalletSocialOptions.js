...
export const ConnectWalletSocialOptions = (props) => {
    ...
    return (_jsxs(Container, { flex: "column", gap: "md", style: {
            position: "relative",
        }, children: [optionalImageMetadata && (_jsxs(_Fragment, { children: [_jsx(Img, { client: props.client, src: optionalImageMetadata.src, alt: optionalImageMetadata.alt, width: `${optionalImageMetadata.width}`, height: `${optionalImageMetadata.height}`, style: { margin: "auto" } }), _jsx(Spacer, { y: "xxs" })] })), hasSocialLogins && (_jsx(Container, { flex: "row", center: "x", gap: socialLogins.length > 4 ? "xs" : "sm", style: {
                ...
                (isEmailEnabled || isPhoneEnabled) && _jsx(TextDivider, { text: locale.or }), isEmailEnabled && (_jsx(_Fragment, { children: inputMode === "email" ? (_jsx(InputSelectionUI, { type: type, onSelect: (value) => {
                    ...
                    }, title: locale.emailPlaceholder, disabled: props.disabled })) })), isPhoneEnabled && (_jsx(_Fragment, { children: inputMode === "phone" ? (_jsx(InputSelectionUI, { format: "phone", type: type, onSelect: (value) => {
                    ...
                    }, title: locale.phonePlaceholder, disabled: props.disabled })) })), passKeyEnabled && (_jsx(_Fragment, { children: _jsx(WalletTypeRowButton, { client: props.client, icon: passkeyIcon, onClick: () => {
                        handlePassKeyLogin();
                    }, title: locale.passkey, disabled: props.disabled }) })), props.isLinking && (_jsx(_Fragment, { children: _jsx(WalletTypeRowButton, { client: props.client, icon: getWalletIcon(""), onClick: () => {
                        handleWalletLogin();
